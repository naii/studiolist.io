<?php
	...
	include '../header.php';
?>		
		<h1>studiolist makes it easy find voiceover recording studios and book studio time<!-- to book studio time at amazing rates --></h1>

		<p>studiolist is a match-maker between top-rated recording studios that have unsold studio time and voiceover artists who want to book this studio time.</p>
		...
		<p>Read <a href="#benefits">how studiolist benefits you</a>, or log in (soon) to request a price<!-- <a href="/login">request a price</a> -->, get the right contact person, book studio time, see the studio on a nice map or share a review. Below you can also read the background story <a href="#story">why I started studiolist</a>.</p>
		
		<h2 id="benefits">Benefits</h2>
		<p>studiolist helps musicians and voice artists <strong>find a recording studio nearby and book it quick!</strong> In contrast to Google, Facebook and their fellow surveillance capitalism colleagues, I ensure all data is stored securely and safely. Except for the studio name, no personal data is being revealed to the public. That’s why a 3-second registration (full name, email address, password) is required.</p>

		<h3>Smart use of existing studio infrastructure</h3>

		<p>With studiolist, I’m using the existing infrastructure of recording studios. As a voiceover artist you only need to bring your skills and a healthy voice to any place where there are studios to record, no need to bring your own computer and equipment. I think that’s an awesome perspective.</p>
		...
		<p>You want an up-to-date list and correct information. Ok, me too. If you found a mistake on studiolist, <a href="/contact/">please send me what’s wrong</a>.</p>
